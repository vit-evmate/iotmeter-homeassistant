...
class TotalPowerSensor(TranslatableSensorEntity):
    ...
    def state(self):
        ...
        p1 = self.coordinator.data.get("P1") - 65535 if self.coordinator.data.get("P1") > 32767 else self.coordinator.data.get("P1")
        p2 = self.coordinator.data.get("P2") - 65535 if self.coordinator.data.get("P2") > 32767 else self.coordinator.data.get("P2")
        p3 = self.coordinator.data.get("P3") - 65535 if self.coordinator.data.get("P3") > 32767 else self.coordinator.data.get("P3")
    ...
    def extra_state_attributes(self):
        ...
        return {
            "P1": round((self.coordinator.data.get("P1") - 65535 if self.coordinator.data.get("P1") > 32767 else self.coordinator.data.get("P1")) / 1000, 2),
            "P2": round((self.coordinator.data.get("P2") - 65535 if self.coordinator.data.get("P2") > 32767 else self.coordinator.data.get("P2")) / 1000, 2),
            "P3": round((self.coordinator.data.get("P3") - 65535 if self.coordinator.data.get("P3") > 32767 else self.coordinator.data.get("P3")) / 1000, 2),
        }
